...
export type SkillTemplate = 'feature' | 'fix' | 'refactor' | 'docs' | 'test' | 'review' | 'blank';
...
export function getSkillTemplate(template: SkillTemplate, ctx: TemplateContext): string {
    switch (template) {
        case 'feature':
...
function featureTemplate(ctx: TemplateContext): string {
    return `---
name: ${ctx.name}
...
function fixTemplate(ctx: TemplateContext): string {
    return `---
name: ${ctx.name}
description: ${ctx.description}
---
...
function refactorTemplate(ctx: TemplateContext): string {
    return `---
name: ${ctx.name}
description: ${ctx.description}
---
...
function docsTemplate(ctx: TemplateContext): string {
    return `---
name: ${ctx.name}
description: ${ctx.description}
---
...
function testTemplate(ctx: TemplateContext): string {
    return `---
name: ${ctx.name}
description: ${ctx.description}
---
...
function blankTemplate(ctx: TemplateContext): string {
    return `---
name: ${ctx.name}
description: ${ctx.description}
---
...
export const TEMPLATE_DESCRIPTIONS: Record<SkillTemplate, string> = {
